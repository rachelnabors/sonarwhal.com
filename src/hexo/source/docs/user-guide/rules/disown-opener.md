---
category: "user-guide"
description: "disown-opener warns against not specifying the rel attributewith both the noopener and noreferrer values (or only noopenerif all the targeted browserssupport it) on a and area elements that have target=\"_blank\"and link to other origins."
layout: "docs"
